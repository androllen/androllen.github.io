...
Name: "install_nmap"; Description: "��װ Nmanp Setup"; GroupDescription: "{cm:Other}";  Flags: checkablealone 
Name: "install_hasp"; Description: "��װ HASPUserSetup"; GroupDescription: "{cm:Other}"; Flags: checkablealone 
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "���� {#MyAppName}"; Flags: postinstall skipifsilent
Filename: "{app}\nmap-7.12-setup.exe"; StatusMsg: "��װ Nmanp Setup"; Check: IsWin64(); Tasks: install_nmap;
Filename: "{app}\HASPUserSetup.exe"; StatusMsg: "��װ HASPUserSetup"; Check: IsWin64(); Tasks: install_hasp;
Filename: "{app}\dotNet4.5-x86-x64.3505182529.exe"; StatusMsg: "��װ dotNet4.5-x86-x64.3505182529.exe"; Check: IsWin64();
