---
title: VS Offline Download And Key
...
```sh
# Visual Studio 2017 Professional key
...
```sh
# Visual Studio 2019 Professional offline download for Desktop
vs_professional.exe –-layout D:\localVScache –-add Microsoft.VisualStudio.Workload.ManagedDesktop;includeRecommended –-add Microsoft.VisualStudio.Workload.VisualStudioExtension --add Component.GitHub.VisualStudio --add Microsoft.VisualStudio.Component.Git -–nickname androllen –-lang zh-CN En-us 
...
```sh
# Visual Studio 2022 Professional key
TD244-P4NB7-YQ6XK-Y8MMM-YWV2J
```

```sh
# Visual Studio 2022 Professional offline download for Desktop
